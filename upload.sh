...
echo "[2/4] Commit..."
git add -A
git commit -m "fix: Vertex AI global endpoint v1.1.1" 2>/dev/null || echo "(Khong co gi thay doi, skip commit)"
...
echo "[4/4] Tag v1.1.1..."
git tag -fa v1.1.1 -m "v1.1.1 - Vertex AI global endpoint fix" 2>/dev/null
git push origin v1.1.1 --force

echo ""
echo "==== XONG ===="
echo "Build: https://github.com/contep2k15-oss/ai-era-media-2/actions"
echo ".exe:  https://github.com/contep2k15-oss/ai-era-media-2/releases/tag/v1.1.1"
